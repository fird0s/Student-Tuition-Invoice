...
address,body{line-height:1.42857143}html{margin:40px 50px}body{font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;font-size:14px;color:#333}address{margin-bottom:20px;font-style:normal}#container{width:700px;margin:0 auto}hr{margin-top:10px;margin-bottom:10px;border:0;border-top:1px solid #000}.title{color:#333;font-weight:700;font-size:17px;line-height:.428571}.value-title{font-size:19px;line-height:1;font-weight:300}
...
<body>
    ...
    <div id='container'>
        ...
        www.unsyiah.ac.id
                ...
                <td style='width: 50%;'>
                    <table style='margin-top: 60px; margin-left: 10px;'>
                        <tr>
                            <td style='text-align: right;'><b>Tanggal Cetak : </b>
                            </td>
                            <td>
                                <?php echo date( "d/m/Y"); ?>
                            </td>
                        ...
                        <tr>
                            <td style='text-align: right;'><b>Jam : </b>
                            </td>
                            <td>
                                <?php echo date( 'h:i:s'); ?>
                            </td>
            ...
            <tr>
                ...
                <td style='width: 33.3%'>
                    ...
                    <div>
                        ...
                        <p class='value-title'>
                            <?php echo $xml->fakultas; ?></p>
                    </div>

                    <div style='margin-top: 30px;'>
                        <p class='title'>Program Studi</p>
                        <p class='value-title'>
                            <?php echo $xml->jurusan; ?></p>
                    </div>
        ...
        <br>
        <hr>
        <footer>UPT TIK (Teknologi Informasi dan Komunikasi) - Universitas Syiah Kuala.
            <br> www.ict.unsyiah.ac.id
        </footer>
